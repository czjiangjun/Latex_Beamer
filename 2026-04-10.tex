...
\end{figure}
	\item 构建\textrm{POTCAR}数据:~将\textrm{PAW}方法与\textrm{USPP}方法关联起来
\end{itemize}
}
...
%当前研究主要尝试:~
	基于开源的\textrm{PAW}赝势数据生成软件(\textrm{atomPAW})，开发生成\textrm{POTCAR}原子数据的功能
}
...
\centering
\vspace{-0.15in}
\includegraphics[height=0.66\textwidth,width=0.47\textwidth,viewport=0 0 2164 3272,clip]{Figures/Portrait-Chongyu_Wang.jpg}
\caption{\fbox{王崇愚}~院士}											      %
\end{figure}												      %
}
%------------------------------------------------------------------------Reference----------------------------------------------------------------------------------------------
