...
\centering
\vspace{-5.5pt}
\includegraphics[height=0.60\textwidth,width=1.0\textwidth,viewport=0 100 750 530,clip]{Figures/Bond-order.png}
%\caption{\textrm{ABINIT}的Si.in}
\label{Bond-order}
\end{figure}
...
\includegraphics[height=1.30in,width=1.50in,viewport=0 25 600 530,clip]{Figures/Van-Der-Waals-Forces-Bond-Interactions-Examples.jpg}
