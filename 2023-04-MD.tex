...
\includegraphics[height=2.80in,width=1.80in,viewport=0 0 430 650,clip]{Figures/De_Broglie-dissertation_Cover.jpg}
%\caption{\textrm{The wave-particle duality and Photoelectric effect}}
\label{Matter_wave}
\end{figure}
}
...
\frame
{
	...
	生理学家刘曾复教授\footnote{\fontsize{6.2pt}{4.2pt}\selectfont{刘曾复教授(\textrm{1914-2012})，我国老一辈生理学家，首都医科大学前身北京第二医学院创始人之一。主要研究方向是电生理学、整合生理学。}}认为
\pgfputat{\pgfxy(11.68,0.15)}{\includegraphics[height=0.95cm,viewport=0 0 510 360,clip]{Figures/Huang.jpg}}\pgfputat{\pgfxy(10.333,-0.195)}{\includegraphics[height=0.35cm,viewport=530 70 1100 218,clip]{Figures/Huang.jpg}}
%\pgfputat{\pgfxy(10.333,-0.195)}{\includegraphics[height=0.35cm,viewport=530 70 1100 218,clip]{Figures/Huang.jpg}}}
	\begin{itemize}
		\item 应该重视系统科学的思想和方法\\
			注意生命体机能的整合调节
		\item 生理学中的整合(\textrm{intergration})类似集成电路\\
			对控制-反馈过程的研究，要有整体的思想
		\item 生理学研究重视整合、调节，应该有新的数学为生理学服务\\
	大数据、\textrm{AI}、机器学习
	\end{itemize}
	$^{\ast}${\fontsize{7.2pt}{4.2pt}\selectfont{根据刘曾复~著、娄悦~编~《刘曾复京剧文存》附录“刘曾复访谈”部分整理}}
}
%------------------------------------------------------------------------Reference----------------------------------------------------------------------------------------------
		\frame[allowframebreaks]
{
