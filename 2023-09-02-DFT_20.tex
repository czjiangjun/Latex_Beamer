...
\verbatiminput{/home/jiangjun/Documents/Latex_Beamer/Figures/VASP-POTCAR_Si-01-localpotential} %为保险:~选用文件名绝对路径
}
\end{minipage}
}
...
\centering
\vspace{-0.05in}
\includegraphics[height=1.15in,width=0.75in,viewport=0 0 350 550, angle=-90, clip]{Figures/PCORE-data.eps}
