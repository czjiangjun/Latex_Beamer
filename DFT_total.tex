...
\frame
{
	...
	\begin{itemize}
		...
		\item 价层不含$d$电子电子体系:引入截断函数
			...
			定义有效赝势
			\begin{displaymath}
				\tilde v_{\mathrm{at}}(r) = \tilde v_{\mathrm{at}}(0)k(r)+[1-k(r)]v_{\mathrm{at}}(r)
			\end{displaymath}
	...
	实际求解赝波函数时的赝势定义为
\begin{displaymath}
	w_i(r)=\tilde v_{\mathrm{at}}(r)+c_ik(r)
\end{displaymath}
...
\frame
{
	...
	如果确定$\tilde v_{\mathrm{at}}(r)$的方程中，波函数满足$$|\tilde\Psi\rangle=|u\rangle+\sum_i|w_i\rangle c_i$$
