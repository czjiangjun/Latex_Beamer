...
\frame
{
	...
	\begin{displaymath}
		\begin{aligned}
			...
			\overset{\text{\textcolor{red}{\textrm{unsrceen}}}}{-}&\textcolor{blue}{\underline{\int\hat Q_{ij}^L(\vec r)\tilde v_{e\!f\!f}^a(\vec r)\mathrm{d}\vec r}} \quadd\rightarrow\quadd \textcolor{red}{\int_{\Omega_r}\mathrm{d}\vec r\,^{\prime}\tilde v_{loc}^a(\vec r\,^{\prime})\hat Q_{mn}(\vec r\,^{\prime})}\\
