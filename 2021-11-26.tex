...
\vskip 55 pt 2021.11.29
\vskip 5 pt 北京师范大学~化学学院}}}
...
\centering
\vspace*{-0.18in}
\includegraphics[height=2.45in,width=3.1in,viewport=0 0 600 495,clip]{Figures/VASP_Total_ENE.png}
...
\caption{\fontsize{6.2pt}{4.9pt}\selectfont{\textrm{Schematic illustration of scattering of a plane wave by a spherical potential.}}}%(与文献\cite{EPJB33-47_2003}图1对比)
...
\caption{\fontsize{6.2pt}{4.9pt}\selectfont{\textrm{Oxygen 2} \textit{p} \textrm{radical wave function (solid), NC-pseudo-wave (dottde) and US-pseudo-wave (dashed).}}}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{Norm-US-wave}
\end{figure}
}
...
\section{\rm{VASP}的\rm{POTCAR}重现路线}
\frame
{
