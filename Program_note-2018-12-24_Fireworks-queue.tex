...
\begin{itemize}
	...
	\item MY_MPI_TYPE=openmpi
	\item #mpi 的路径，在系统下，可以通过which mpicc查看
	\item MY_MPI_HOME=/share/software/program/01_openmpi-1.6.3
	\item MY_MPI_HOME=/share/software/program/02_openmpi-1.8.4

	\item #任务调用的核心数，为NP_PER_NODE的整数倍将获得更好的计算效率，该参数根据任务计算量大小常调整
	\item NP=24
	\item #命令行参数
	\item RUN="/share/home/czjiangjun/vasp/vasp_std > log"
	\item #vasp：RUN="vasp"
	\item #lammps:RUN="lmp_openmpi < relax.in > relax.log"
