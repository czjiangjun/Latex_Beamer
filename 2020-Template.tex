...
%\usepackage[numbers,sort&compress]{footbib} %脚注引用             %
...
\frame[allowframebreaks]
{
	...
	文献引用\footnote{%文献在脚注中出现
		\begin{thebibliography}{99}
	\fontsize{5.2pt}{1.9pt}\selectfont{
		\vspace*{-13pt}
	\bibitem{Xu_Li_Wang}徐光宪、黎乐民、王德民, {\textit{量子化学——基本原理和从头计算法}}\;\textrm{({\textit{上、中}})}\:科学出版社, 北京, 1980}
\end{thebibliography}
\nocite*{}}\upcite{Huang_Han,Xie_Lu,Xu-Li-I-II,Dai_Qian,Many-Body_Theory,JPC-SSP12-4409_1979,WIEN2K-UG_2001,VASP_manual,PCCP8-3172_2006}
