...
%\caption{\fontsize{7.2pt}{4.2pt}\selectfont{\textrm{The integrated calculator in ASE (Atomic Simulation Environment).}}}%
\label{Logo_atoms-module-example}
\end{figure} 
\end{minipage}
}
...
\caption{\tiny\textrm{System-Model for MaxKB}}%(与文献\cite{EPJB33-47_2003}图1对比)
...
\caption{\tiny\textrm{User-Config for MaxKB}}%(与文献\cite{EPJB33-47_2003}图1对比)
