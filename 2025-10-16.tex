...
\includegraphics[height=2.05in,width=3.95in,viewport=0 0 2300 1180,clip]{Figures/YbOPCH-OUTCAR-2.png}
%\caption{\tiny \textrm{千原子合金模型($\vec k$点:~\textcolor{red}{$2\times2\times2$} vs~\textcolor{red}{$1\times1\times1$}).}}%(与文献\cite{EPJB33-47_2003}图1对比)
...
\centering
\vskip -0.10in
\includegraphics[height=2.60in,width=4.05in,viewport=0 0 2180 1220,clip]{Figures/YbOPCH-OUTCAR-5.png}
