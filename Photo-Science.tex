...
\usepackage{silence} \WarningFilter{latex}{movie15_dvipdfmx}
...
\centering
\vspace{-10.5pt}
\includegraphics[height=0.46\textwidth,width=0.9\textwidth,viewport=0 0 850 420,clip]{Figures/Quote-Ernest_Rutherford.jpg}
%\caption{\textrm{ABINIT}的Si.in}
...
{
	\frametitle{存乎一心}
%	\centering{岳飞:``\textcolor{red}{阵而后战，兵法之常；运用之妙，存乎一心}''}
	\centering{\textcolor{red}{阵而后战，兵法之常；运用之妙，存乎一心}}
\begin{figure}[h!]
\centering
\vspace{-0.5pt}
\includegraphics[height=0.60\textwidth]{Figures/Quote-YueFei.png}
\caption{\fontsize{6.2pt}{5.2pt}\selectfont{[元]~脱脱~等~《宋史\,$\cdot$\,列传\,$\cdot$\,卷一百二十四》}}
\label{Sale_oil}
\end{figure}
}
...
\centering
\vspace{-0.15in}
%\includegraphics[height=0.71\textwidth,width=1.0\textwidth,viewport=0 0 1142 720,clip]{Figures/The_School_of_Athens-High.jpg}
\includegraphics[height=0.71\textwidth,width=1.0\textwidth,viewport=0 0 915 720,clip]{Figures/The_School_of_Athens.jpg}
