...
\fbox{%
	...
	\tiny{	\textrm{\textcolor{magenta}{noncollinear}=0}:~ \#共线磁结构搜索\\
		\textrm{\textcolor{magenta}{afm}=1}:~ \#搜索反铁磁结构\\
\textrm{\textcolor{magenta}{generation}=30}:~ \#演化30代\\
\textrm{\textcolor{magenta}{population}=30}:~ \#每一代计算30个结构\\
\textrm{\textcolor{magenta}{pop\_best}=8}:~ \#保留8个最优结构\\
\textrm{\textcolor{magenta}{n\_random}=10}:~ \#每一代包含10个随机结构 }}
}
}
...
\fbox{%
		...
		\textrm{\textcolor{magenta}{noncollinear}=1}:~ \#非共线磁结构搜索\\
		\textrm{\textcolor{magenta}{afm}=0}:~ \#不限于搜索反铁磁结构\\
\textrm{\textcolor{magenta}{generation}=30}:~ \#演化30代\\
\textrm{\textcolor{magenta}{population}=30}:~ \#每一代计算30个结构\\
\textrm{\textcolor{magenta}{pop\_best}=8}:~ \#保留8个最优结构\\
\textrm{\textcolor{magenta}{n\_random}=10}:~ \#每一代包含10个随机结构 }}
...
\fbox{%
	...
	\tiny{	\textrm{\textcolor{magenta}{noncollinear}=1}:~ \#非共线磁结构搜索\\
		\textrm{\textcolor{magenta}{afm}=1}:~ \#搜索反铁磁结构\\
\textrm{\textcolor{magenta}{generation}=30}:~ \#演化30代\\
\textrm{\textcolor{magenta}{population}=30}:~ \#每一代计算30个结构\\
\textrm{\textcolor{magenta}{pop\_best}=8}:~ \#保留8个最优结构\\
\textrm{\textcolor{magenta}{n\_random}=3}:~ \#每一代包含3个随机结构 }}
}
}
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------%
\appendix
