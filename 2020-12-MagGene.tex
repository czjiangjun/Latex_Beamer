...
\frame
{
	\frametitle{块体\ch{FeSe}}
\ch{FeSe}具有非常复杂的磁有序结构
	\begin{itemize}
		\item 块体\ch{FeSe}:~具有超导电性$\mathrm{T_c}\sim8\mathrm{K}$
\begin{figure}[h!]
%\vspace*{-0.08in}
\centering
...
\caption{\tiny \textrm{The bulk-structure of \ch{FeSe}. and hysteresis loop. }}%(与文献\cite{EPJB33-47_2003}图1对比)
...
\frame
{
	\frametitle{单层\ch{FeSe}}
	\begin{itemize}
\item 单层\ch{FeSe}具有更高的转变温度$\mathrm{T_c}\sim65\mathrm{K}$
\begin{figure}[h!]
\vspace*{-0.08in}
\centering
