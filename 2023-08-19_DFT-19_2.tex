...
\caption{\textrm{\tiny Mott transition within the Hubbard model.From \cite{PT57-53_2004}}}%}}%(图1对比)
\label{Mott_Hubbard}
\end{figure}
\end{minipage}
\hfill
...
\centering
\vspace{-5pt}
\includegraphics[height=1.7in,width=1.70in,viewport=0 0 800 770,clip]{Figures/Lattice_Many-body-states.png}
%\caption{\textrm{\tiny The schematic diagram of electron-structure from DFT, DMFT and DFT+$U$.}}%(与文献\cite{EPJB33-47_2003}图1对比)
\label{Localized-multiplets}
\end{figure}
	将量子多电子问题转成有效场中的量子杂质问题
	\begin{displaymath}
