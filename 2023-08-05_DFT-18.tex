...
\caption{\tiny \textrm{Schematic examples Acoustic (in-phase) and optic (out-of-phase) modes.}}%
\label{Aucous-Optic}
\end{figure} 
}
...
%\hspace*{-10pt}
\vspace*{-0.20in}
\includegraphics[height=2.4in,width=4.0in,viewport=0 0 850 610,clip]{Figures/examples-of-transverse-optical-to-and-longitudinal-optical-lo-phonons-in-1d.png}
\caption{\tiny \textrm{Schematic examples of transverse optical to and longitudinal optical lo phonons in 1d diatomic lattice.}}%
\label{To-Lo-1D}
\end{figure} 
}
