...
\frame
{
	...
	\end{displaymath}
	\textcolor{blue}{$\lambda$表征电子间相互作用程度}\\
	\begin{displaymath}
		\begin{aligned}
...
\begin{figure}[h!]
\centering
\includegraphics[height=3.2in,width=4.0in,viewport=0 0 950 590,clip]{Figures/Coordinate_transformation.png}
\label{decent_CG}
