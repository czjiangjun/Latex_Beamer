...
\frame
{
	\frametitle{\textrm{ASE}的模块:~\textrm{Calculator}}
...
\frame
{
	\frametitle{\textrm{ASE}的数据库管理:~\textrm{MySQL}}
...
\frame
{
	\frametitle{\textrm{FireWorks}的结构}
...
\caption{\fontsize{7.2pt}{4.2pt}\selectfont{\textrm{FireWorks}的架构(左)、工作流组成(中)和单元组间数据传递与处理(右)示意.}}%
\label{FireWorks_FW}
\end{figure} 
}
