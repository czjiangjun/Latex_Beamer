...
\centering
\vspace*{-0.15in}
\includegraphics[height=2.75in,width=3.30in,viewport=0 0 818 616,clip]{Figures/MS-New_Project-08.png}
...
\centering
\vspace*{-0.10in}
\includegraphics[height=2.65in,width=2.60in,viewport=0 0 756 787,clip]{Figures/MS-CASTEP-02-Si-parameter.png}
...
\centering
\vspace*{-0.10in}
\includegraphics[height=1.45in,width=4.00in,viewport=0 0 1070 452,clip]{Figures/MS-CASTEP-03-Si-input-1.png}
\includegraphics[height=1.25in,width=4.00in,viewport=0 0 1070 335,clip]{Figures/MS-CASTEP-03-Si-input-2.png}
