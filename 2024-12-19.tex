...
\frame
{
	...
	\node[xshift=3.8cm,yshift=-1.43cm] at (current page.east) {\includegraphics[height=2.5cm, width=2.22cm, viewport=360 0 1350 1100,clip]{/home/jiangjun/Documents/Peking_Opera/Figures/Liu_Zengfu_2.jpg}};
	\end{tikzpicture}
	\begin{itemize}
...
%总结了京剧特色和艺术风格，前者是基于对中国戏曲各剧种的音韵声腔、表演、化妆等的一般共同属性横向比较，后者则是通过解析程长庚-谭鑫培-杨(小楼)、梅(兰芳)、余(叔岩)传承中延续、完善的艺术风格后提炼的；书中
	\begin{itemize}
		\item 通过相对定量的``广谱型''表示方法，概括京剧老生演唱和表演风格，以及各流派风格的影响%的讨论，则是使人对谭及身后的影响一目了然；至于对。这种``多指标'' 、 ``定性-定量结合''的评价， 实际上是科研中系统研究思想在京剧研究的应用。
\begin{figure}[h!]
\centering
\vspace{-0.1in}
%\includegraphics[height=0.64\textwidth,width=0.46\textwidth,viewport=0 0 360 520,clip]{Figures_Peking-Opera/Liu_Zengfu.jpg}
...
\centering
\vspace{-0.1in}
\includegraphics[height=0.28\textwidth,width=0.70\textwidth,viewport=0 0 1198 510,clip]{Figures_Peking-Opera/Liu_Letter.jpg}
%\caption{刘曾复先生}
\label{Liu_Letter}
\end{figure}
}
