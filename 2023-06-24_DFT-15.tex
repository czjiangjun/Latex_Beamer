...
\frame
{
	\frametitle{\textrm{Mott-Hubbard insulator and charge transfer insulator.}}
\begin{figure}[h!]
\centering
\vspace*{-0.10in}
...
\centering
\vspace*{-0.22in}
\includegraphics[height=1.45in,width=2.82in,viewport=0 0 585 350,clip]{Figures/Crystal-Field-Theory.jpg}
