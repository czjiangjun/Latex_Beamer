...
\frame
{
	\frametitle{能量量子化:~从驻波方程到\rm{Schr\"odinger}方程}
	\begin{itemize}
		\item \textrm{L.~de~Brogile}提出物质波的概念
			\begin{displaymath}
				\lambda = \hbar/p
			\end{displaymath}
		\item \textrm{Schr\"odinger}受到物质波概念的启发提出\textrm{Schr\"odinger}方程
			\begin{displaymath}
				-\dfrac{\hbar^2}{2m}\bigg(\dfrac{\partial^2\Psi}{\partial x^2}+\dfrac{\partial^2\Psi}{\partial y^2}+\dfrac{\partial^2\Psi}{\partial z^2}\bigg)+V(x,y,z)\Psi=\mathrm{i}\hbar\dfrac{\partial\Psi}{\partial t}
			\end{displaymath}
	\end{itemize}
\begin{figure}[h!]
\centering
\vspace{-10.5pt}
\includegraphics[height=0.57in,width=0.75in,viewport=0 0 125 76,clip]{Figures/Standing_wave.jpeg}
\hskip 0.1pt
\includegraphics[height=0.49in,width=1.75in,viewport=110 170 1890 655,clip]{Figures/Standing_wave_atom.jpeg}
\hskip 0.1pt
\includegraphics[height=0.65in,width=1.25in,viewport=0 0 1200 550,clip]{Figures/Standing_wave-energy.jpg}
\caption{\textrm{The Standing-wave and energy.}}
\label{Standing_wave}
\end{figure}
}
...
\centering
\vspace{10.5pt}
\includegraphics[height=0.40\textwidth,width=0.45\textwidth,viewport=0 0 680 500,clip]{Figures/Element_Geometry_1.jpg}
\includegraphics[height=0.40\textwidth,width=0.53\textwidth,viewport=0 0 750 480,clip]{Figures/Philp_Nature_Mach-2.png}
...
\frame
{
	\frametitle{\rm{Schr\"odinger's~cat}}
\begin{figure}[h!]
\centering
\vspace{-10.5pt}
...
\caption{\fontsize{6.2pt}{5.5pt}\selectfont{\textrm{左1:~王守竞，左2:~Ralph Kronig 右1:~I. I. Rabi(1944年诺贝尔物理学奖获得者)}}}
\label{Collect_Wang}
\end{figure}
}
...
\frame
{
	\frametitle{日常生活中最重要的基组:~货币}
\begin{figure}[h!]
\centering
\vspace{-15.0pt}
\includegraphics[height=0.66\textwidth,width=0.75\textwidth,viewport=0 0 160 160,clip]{Figures/Basis_set_example.png}
\caption{\fontsize{6.2pt}{5.5pt}\selectfont{\textrm{第三版人民币(纸币)构成的完备基组}}}
\label{Basis_Set_RMB}
\end{figure}
}
