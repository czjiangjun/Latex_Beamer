...
\vspace*{-0.08in}
\centering
\includegraphics[height=1.55in,width=2.35in]{MGE.png}
\label{MGE}
\end{figure}
...
\centering
\hspace*{-0.30in}
\includegraphics[height=1.45in,width=1.15in]{Computing_Materials.jpg}
\hspace{0.05pt}
\includegraphics[height=1.45in,width=2.40in]{DFT-total.png}
\label{TEXT_PPT}
\end{figure}
	\end{itemize}
	\newpage
...
\vspace*{-0.02in}
\centering
\includegraphics[height=1.55in,width=1.15in]{DFT_Wang.jpg}
\label{DFT_Wang}
\end{figure}
		 \item 结构材料的化学组元与占位\\
			配位场与化学键理论
...
\vspace*{-0.02in}
\centering
\includegraphics[height=1.25in,width=1.55in]{Engineering_1.png}
\hspace{0.01pt}
\includegraphics[height=1.25in,width=1.65in]{Engineering_2.png}
\label{Engineering}
\end{figure}
...
\vspace*{-0.20in}
\centering
\includegraphics[height=2.90in,width=3.70in]{Main-qimg.jpeg}
\label{BMDS}
\end{figure}
	\end{itemize}
}
