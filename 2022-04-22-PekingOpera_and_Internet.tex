...
%----------------------------Author & Date------------------------------------
\author[\textrm{Jun\_Jiang}]{\vskip 30pt 姜~骏\inst{}
%\vskip -20pt \includegraphics[scale=0.03]{Figures/signature-seal_Jiang-1.png} % 加入个人名章 
%\vskip -20pt \includegraphics[scale=0.11]{Figures/seal_Jiang-2.jpg} % 加入个人名章 
...
\verbatiminput{/home/jun_jiang/Documents/Latex_art_beamer/Presentation_Beamer/Figures/PekOpe_Shuimu.txt} %为保险:~选用文件名绝对路径
}
}
...
\vspace{-0.2in}
\hspace*{-0.15in}
\includegraphics[height=0.35\textwidth,width=0.45\textwidth,clip]{Figures/PekOpe_Guo.jpg}
\vskip 1pt
\includegraphics[height=0.45\textwidth,width=0.55\textwidth,clip]{Figures/PekOpe_Laochezhan-1.jpg}
%\includegraphics[height=0.40\textwidth,width=0.45\textwidth,clip]{Figures/PekOpe_Laochezhan-2.jpg}\\
...
\centering
\vspace{-0.05in}
\includegraphics[height=0.60\textwidth,width=0.6\textwidth,clip]{Figures/PekOpe_Beiming.png}
\label{Beiming}
\end{figure}
}
...
\centering
\vspace{-0.05in}
\includegraphics[height=0.65\textwidth,width=0.90\textwidth,clip]{Figures/PekOpe_Xiyou-1.jpg}
\label{Xiyou-1}
\end{figure}
}
...
\centering
\vspace{-0.15in}
%\includegraphics[height=0.45\textwidth,width=0.65\textwidth,clip]{Figures/PekOpe_Wu-4.jpg}
%\vskip -25pt
...
\verbatiminput{/home/jun_jiang/Documents/Latex_art_beamer/Presentation_Beamer/Figures/PekOpe_Xi.txt} %为保险:~选用文件名绝对路径
}
\end{minipage}
}
