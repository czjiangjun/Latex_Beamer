...
%\label{Black_box}
%\end{figure}
%	{\fontsize{8.0pt}{4.2pt}\selectfont{\textrm{Rayleigh-Jeans}公式\footnote{\fontsize{6.2pt}{4.2pt}\selectfont{\textrm{Rayleigh}提出，经\textrm{Jeans}作小的修正}}给出的黑体辐射
%	\begin{displaymath}
...
%		\end{aligned}
%	\end{displaymath}
%	最初\textrm{Wien}提出近似时并不包含\textrm{Planck}常数，他选择黑体辐射的波长和原子的\textrm{Maxwell-Boltzmann}分布来表示该常数 }} 
%
