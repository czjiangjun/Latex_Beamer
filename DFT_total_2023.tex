...
%\textrm{1896}年，\textrm{Wien}从热力学角度提出黑体辐射强度的近似表示:
%\begin{displaymath}
...
%%\end{itemize}
%%		随后\textrm{Rayeigh}指出，当$\lambda T$较大时，\textrm{Wien}近似中指数$\mathrm{e}^{-c_1/\lambda T}\rightarrow1$，此时辐射强度将与温度成正比

%\textrm{Rayleigh-Jeans}公式\footnote{\fontsize{6.2pt}{4.2pt}\selectfont{\textrm{Rayleigh}提出，经\textrm{Jeans}作小的修正}}给出的黑体辐射强度
%	\begin{displaymath}
...
%\begin{frame}[allowframebreaks]
%	\frametitle{黑体辐射与能量量子化}
%\textrm{Planck}根据{Boltzmann}统计物理和\textrm{Maxwell}电动力学，提出:
%
