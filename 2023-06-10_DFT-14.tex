...
\frame{
	...
	\begin{itemize}
		\item 角频率为$\omega$的电磁波(横波)在均匀介质中传播(设为$x$方向)
			\begin{displaymath}
				\mathbf{E}(\vec r,t)=E(z)\mathrm{e}^{-\mathrm{i}\omega t}(1,0,0)\qquad\mathbf{E}\perp x
			\end{displaymath}
...
%\hspace*{-10pt}
\vspace*{-0.05in}
\includegraphics[height=1.9in,width=4.0in,viewport=0 0 1500 600,clip]{Figures/Inter_band-transition_abs-emi.png}
...
%\hspace*{-10pt}
%\vspace*{-0.00in}
\includegraphics[height=1.7in,width=1.95in,viewport=0 0 950 700,clip]{Figures/Optical_gain-loss.png}
\includegraphics[height=1.2in,width=1.95in,viewport=0 0 680 460,clip]{Figures/Optical_Bandgap.jpg}
\caption{\fontsize{5.2pt}{4.0pt}\selectfont\textrm{Schematic representation of the gain-loss spectra and the spectra vs the band gap.}}%
